...
import com.firecode.dischole.exceptions.ContentFetchException;
import com.firecode.dischole.exceptions.PageBiggerThanMaxSizeException;
import com.firecode.dischole.exceptions.ParseException;
import com.firecode.dischole.fetcher.PageFetchResult;
import com.firecode.dischole.fetcher.PageFetcher;
import com.firecode.dischole.parser.ParseData;
import com.firecode.dischole.parser.Parser;
...
public class WebCrawler implements Runnable {
    ...
    protected static final Log logger = LogFactory.getLog(WebCrawler.class);
    ...
    protected void onPageBiggerThanMaxSize(String urlStr, long pageSize) {
        logger.warn(String.format("Skipping a URL: {} which was bigger ( {} ) than max allowed size", urlStr,
                    pageSize));
    }
    ...
    protected void onUnexpectedStatusCode(String urlStr, int statusCode, String contentType,
                                          String description) {
        logger.warn(String.format("Skipping URL: {}, StatusCode: {}, {}, {}", urlStr, statusCode, contentType,
                    description));
    ...
    protected void onContentFetchError(WebURL webUrl) {
        logger.warn(String.format("Can't fetch content of: {}", webUrl.getURL()));
        // Do nothing by default (except basic logging)
        // Sub-classed can override this to add their custom functionality
    }
    ...
    protected void onContentFetchError(Page page) {
        logger.warn(String.format("Can't fetch content of: {}", page.getWebURL().getURL()));
        // Do nothing by default (except basic logging)
        // Sub-classed can override this to add their custom functionality
    }
    ...
    protected void onUnhandledException(WebURL webUrl, Throwable e) {
        ...
        logger.warn(String.format("Unhandled exception while fetching {}: {}", urlStr, e.getMessage()));
    ...
    protected void onParseError(WebURL webUrl) {
        logger.warn(String.format("Parsing error of: {}", webUrl.getURL()));
        ...
        try {
            ...
            if (statusCode < 200 ||
                ...
                if (statusCode == HttpStatus.SC_MOVED_PERMANENTLY ||
                    ...
                    if (movedToUrl == null) {
                        logger.warn(String.format("Unexpected error, URL: {} is redirected to NOTHING",
                                    curURL));
                        return;
                    }
                    ...
                    if (myController.getConfig().isFollowRedirects()) {
                        ...
                        if (newDocId > 0) {
                            logger.debug(String.format("Redirect page: {} is already seen", curURL));
                            return;
                        }
                        ...
                        if (shouldVisit(page, webURL)) {
                            ...
                            logger.debug(String.format("Not visiting: {} as per your \"shouldVisit\" policy",
                                         webURL.getURL()));
                        }
                    }
                ...
                if (!curURL.getURL().equals(fetchResult.getFetchedUrl())) {
                    if (docIdServer.isSeenBefore(fetchResult.getFetchedUrl())) {
                        logger.debug(String.format("Redirect page: {} has already been seen", curURL));
                        return;
                    }
                ...
                if (shouldFollowLinksIn(page.getWebURL())) {
                    ...
                    logger.debug(String.format("Not looking for links in page {}, "
